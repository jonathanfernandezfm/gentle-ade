...
- [ ] T4 Web: `apps/web/src/state/gentleAi.ts` atoms + hooks; hub route `/gentle-ai`; components under `apps/web/src/components/gentle-ai/`; settings section `settings.gentle-ai.tsx`; sidebar entry.
