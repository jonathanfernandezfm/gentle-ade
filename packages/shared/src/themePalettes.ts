...
export const GENTLE_ROSE_THEME: ThemeDefinition = {
  id: "gentle-rose",
  label: "Gentle Rose",
  appearance: "dark",
  colors: {
    canvas: "oklch(0.195078 0.017376 335.306)",
    chrome: "oklch(0.195078 0.017376 335.306)",
    toolbar: "oklch(0.195078 0.017376 335.306)",
    toolbarForeground: "oklch(0.950693 0.030394 345.959)",
    toolbarBorder: "oklch(0.335078 0.050168 345.718)",
    toolbarControl: "oklch(0.285078 0.03587 345.718)",
    toolbarControlForeground: "oklch(0.950693 0.030394 345.959)",
    toolbarControlHover: "oklch(0.335078 0.044148 345.718)",
    surface: "oklch(0.210078 0.027592 345.718)",
    surfaceRaised: "oklch(0.245078 0.027592 345.718)",
    surfaceOverlay: "oklch(0.270078 0.027592 345.718)",
    text: "oklch(0.950693 0.030394 345.959)",
    textMuted: "oklch(0.625058 0.023857 343.148)",
    border: "oklch(0.355078 0.043897 345.718)",
    input: "oklch(0.405078 0.050168 345.718)",
    focus: "oklch(0.777876 0.125419 345.718)",
    accent: "oklch(0.777876 0.125419 345.718)",
    accentForeground: "oklch(0.222003 0.03479 328.979)",
    secondary: "oklch(0.295078 0.06271 345.718)",
    secondaryForeground: "oklch(0.95 0.030957 345.718)",
    muted: "oklch(0.255078 0.043897 345.718)",
    mutedForeground: "oklch(0.635974 0.034102 345.416)",
    placeholder: "oklch(0.628713 0.027717 345.592)",
    secondaryLabel: "oklch(0.625058 0.023857 343.148)",
    iconMuted: "oklch(0.625058 0.023857 343.148)",
    error: "oklch(0.655108 0.221148 23.473)",
    errorForeground: "oklch(0.702184 0.189226 22.228)",
    errorSurface: "oklch(0.271537 0.057437 10.532)",
    warning: "oklch(0.772406 0.172798 65.367)",
    warningForeground: "oklch(0.829017 0.171221 81.038)",
    warningSurface: "oklch(0.298993 0.046341 60.397)",
    update: "oklch(0.777876 0.125419 345.718)",
    updateForeground: "oklch(0.95 0.030957 345.718)",
    updateSurface: "oklch(0.335078 0.068981 345.718)",
    accentSurface: "oklch(0.325078 0.068981 345.718)",
    accentSurfaceForeground: "oklch(0.95 0.030957 345.718)",
    messageSurface: "oklch(0.355078 0.075252 345.718)",
    messageForeground: "oklch(0.95 0.030957 345.718)",
    messageAction: "oklch(0.837791 0.091292 35.725)",
    messageActionForeground: "oklch(0.222003 0.03479 328.979)",
    messageActionHover: "oklch(0.897876 0.054449 35.718)",
    codeBackground: "oklch(0.230078 0.022074 345.718)",
    codeForeground: "oklch(0.950693 0.030394 345.959)",
    sidebar: "oklch(0.240078 0.038629 345.718)",
    sidebarForeground: "oklch(0.95 0.030957 345.718)",
    sidebarMutedForeground: "oklch(0.649317 0.032127 344.791)",
    sidebarControlSurface: "oklch(0.295078 0.041388 345.718)",
    sidebarRowHover: "oklch(0.275078 0.056439 345.718)",
    sidebarRowActive: "oklch(0.315078 0.068981 345.718)",
    sidebarRowSelected: "oklch(0.335078 0.075252 345.718)",
    sidebarBorder: "oklch(0.365078 0.050168 345.718)",
    terminalBackground: "oklch(0.195078 0.017376 335.306)",
    terminalForeground: "oklch(0.950693 0.030394 345.959)",
    terminalCursor: "oklch(0.777876 0.125419 345.718)",
    terminalSelection: "oklch(0.375078 0.068981 345.718)",
    terminalScrollbar: "oklch(0.415078 0.027592 345.718)",
    terminalScrollbarHover: "oklch(0.495078 0.027592 345.718)",
  },
  variants: {
    light: {
      canvas: "oklch(0.977831 0.00661 340.387)",
      chrome: "oklch(0.977831 0.00661 340.387)",
      toolbar: "oklch(0.977831 0.00661 340.387)",
      toolbarForeground: "oklch(0.199425 0.035638 343.411)",
      toolbarBorder: "oklch(0.877831 0.064367 344.348)",
      toolbarControl: "oklch(0.927831 0.046022 344.348)",
      toolbarControlForeground: "oklch(0.199425 0.035638 343.411)",
      toolbarControlHover: "oklch(0.887831 0.056643 344.348)",
      surface: "oklch(0.962831 0.02317 344.348)",
      surfaceRaised: "oklch(0.927831 0.035402 344.348)",
      surfaceOverlay: "oklch(0.902831 0.035402 344.348)",
      text: "oklch(0.199425 0.035638 343.411)",
      textMuted: "oklch(0.543949 0.019794 340.596)",
      border: "oklch(0.857831 0.056321 344.348)",
      input: "oklch(0.817831 0.064367 344.348)",
      focus: "oklch(0.613141 0.160918 344.348)",
      accent: "oklch(0.613141 0.160918 344.348)",
      accentForeground: "oklch(0 0 0)",
      secondary: "oklch(0.917831 0.053354 344.348)",
      secondaryForeground: "oklch(0.2 0.035 344.348)",
      muted: "oklch(0.937831 0.039627 344.348)",
      mutedForeground: "oklch(0.519625 0.035646 342.803)",
      placeholder: "oklch(0.513225 0.033801 342.969)",
      secondaryLabel: "oklch(0.543949 0.019794 340.596)",
      iconMuted: "oklch(0.543949 0.019794 340.596)",
      error: "oklch(0.637823 0.237287 25.436)",
      errorForeground: "oklch(0.509494 0.208583 28.513)",
      errorSurface: "oklch(0.942433 0.023558 5.984)",
      warning: "oklch(0.772406 0.172798 65.367)",
      warningForeground: "oklch(0.549154 0.156188 45.359)",
      warningSurface: "oklch(0.958355 0.018701 59.793)",
      update: "oklch(0.613141 0.160918 344.348)",
      updateForeground: "oklch(0.2 0.035 344.348)",
      updateSurface: "oklch(0.887831 0.074958 344.348)",
      accentSurface: "oklch(0.897831 0.067615 344.348)",
      accentSurfaceForeground: "oklch(0.2 0.035 344.348)",
      messageSurface: "oklch(0.877831 0.082449 344.348)",
      messageForeground: "oklch(0.2 0.035 344.348)",
      messageAction: "oklch(0.592873 0.145324 34.294)",
      messageActionForeground: "oklch(0 0 0)",
      messageActionHover: "oklch(0.533141 0.144826 34.348)",
      codeBackground: "oklch(0.942831 0.028322 344.348)",
      codeForeground: "oklch(0.199425 0.035638 343.411)",
      sidebar: "oklch(0.932831 0.04301 344.348)",
      sidebarForeground: "oklch(0.2 0.035 344.348)",
      sidebarMutedForeground: "oklch(0.511522 0.036772 342.973)",
      sidebarControlSurface: "oklch(0.907831 0.053103 344.348)",
      sidebarRowHover: "oklch(0.917831 0.053353 344.348)",
      sidebarRowActive: "oklch(0.887831 0.074958 344.348)",
      sidebarRowSelected: "oklch(0.877831 0.082449 344.348)",
      sidebarBorder: "oklch(0.857831 0.064367 344.348)",
      terminalBackground: "oklch(0.977831 0.00661 340.387)",
      terminalForeground: "oklch(0.199425 0.035638 343.411)",
      terminalCursor: "oklch(0.613141 0.160918 344.348)",
      terminalSelection: "oklch(0.857831 0.088505 344.348)",
      terminalScrollbar: "oklch(0.817831 0.035402 344.348)",
      terminalScrollbarHover: "oklch(0.757831 0.035402 344.348)",
    },
  },
  sidebarArtwork: true,
};
