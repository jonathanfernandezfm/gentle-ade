...
<header>↑ Drag Gentle ADE into the list above</header>
<button id="app" draggable="true" aria-label="Drag Gentle ADE to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Gentle ADE</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Gentle ADE icon is missing.");
