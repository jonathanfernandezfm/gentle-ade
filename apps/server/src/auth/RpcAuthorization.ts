...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.gentleAiGetStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.gentleAiGetProjectStatus]: AuthOrchestrationReadScope,
  // Doctor and the update check only read and report, but both spawn the CLI,
  // so they sit with the operations rather than with the plain reads.
  [WS_METHODS.gentleAiRunDoctor]: AuthOrchestrationOperateScope,
  [WS_METHODS.gentleAiCheckUpdates]: AuthOrchestrationOperateScope,
  [WS_METHODS.gentleAiRunCommand]: AuthOrchestrationOperateScope,
  [WS_METHODS.gentleAiSetReviewMode]: AuthOrchestrationOperateScope,
  [WS_METHODS.gentleAiRefreshSkillRegistry]: AuthOrchestrationOperateScope,
